...
const Feedback = () => {
  ...
  return (
    <section className="bg-gradient-to-r from-blue-500 via-purple-600 to-pink-500 min-h-screen py-16 relative overflow-hidden">
      {/* Section Title */}
      ...
      <div className="relative flex justify-center items-end h-[500px] mx-auto max-w-4xl">
        ...
        {steps.map((step, index) => (
          ...
          >
            ...
            />
            <h3 className="text-xl font-semibold text-gray-800 mb-2">{step.stepName}</h3>
